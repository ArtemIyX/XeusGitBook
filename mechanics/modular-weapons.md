...
укоятки, специально разработанные для быстрой наводки оружия, являются компонентами, которые помогают стрелку эффективно и оперативно прицелиться на цель. Они обеспечивают улучшенное управление и стабильность при стрельбе, повышая точность и скорость наведения на цель.
...
Например _лезвие_, _голова молота_ или _булавы_ и _наконечник копья_. В модуле хранятся такие параметры оружия ближнего боя, как:
